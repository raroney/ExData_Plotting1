...
# energy sub metering readings measured on the 1st and 2nd of February 2007.
# The plot will be saved in a file named "plot3.png".
#
...
# 2. Create our "Plot 3", saving it to a 480x480 png image file.
...
legend("topright", legend = c("Sub_metering_1", "Sub_metering_1", "Sub_metering_3"), 
       lty=c(1,1,1), col=c("black","orangered3", "blue"))
